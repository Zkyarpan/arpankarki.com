  ...
  return (
    <figure
      className={cn(
        ...
        // light styles
        "border-gray-950/[.3] bg-gray-950/[.15] hover:bg-gray-950/[.3]", // Darken the background
        // dark styles
        "dark:border-gray-50/[.2] dark:bg-gray-50/[.05] dark:hover:bg-gray-50/[.1]" // Add more visibility for the dark mode
      )}
    >
